...
public class NativeLibLoader {
    ...
    public static final String NATIVE_FOLDER_PATH_PREFIX = "tuned-native-libs";
    ...
    public static void loadLibraryFromJar(String path) {
        ...
        try (InputStream is = NativeLibLoader.class.getResourceAsStream(path)) {
            ...
            temp.delete();
            throw new RuntimeException("Unable to copy JAR to path");
        } catch (NullPointerException e) {
            temp.delete();
            throw new RuntimeException("File " + path + " was not found inside JAR.");
        }
